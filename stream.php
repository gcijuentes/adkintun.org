...
/*
<img id="image0" src="http://200.72.168.146:8080/videostream.cgi?user=admin&amp;pwd=" class="img-responsive img-rounded detailimage" alt="" title="Click here to enter the camera located in Chile, region Region Metropolitana, Santiago">
*/

$host = "200.72.168.146";
$port = "8080";
//$url = "/videostream.cgi?user=admin&password=pass";
  $url = "/videostream.cgi?user=admin&amp;pwd=";
// Image settings:
