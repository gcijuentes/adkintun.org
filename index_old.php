    ...
    <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">El mundo al instante β!</a>
                </div>
                ...
                <p class="hidden-lg hidden-md">Dashboard</p>
                        ...
                        <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span id="count" class="notification invisible notCount hidden-sm hidden-xs">5</span>
                  <p id="countCel" class="hidden-lg hidden-md notCountCel invisible">
                    5 Notifications
                    <b class="caret"></b>
                  </p>
                              </a>
                              <ul class="dropdown-menu dropdown-camsList">
